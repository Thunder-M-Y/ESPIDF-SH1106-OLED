...
void app_main(void)
{
    ...
    // // 显示汉字
    // OLED_ShowCHinese(0 * 18, 1, 0);
    // OLED_ShowCHinese(1 * 18, 1, 1);
     //OLED_ShowCHinese(2 * 18, 1, 2);

    // // 显示单个字符
     OLED_ShowChar(1, 2, 'Q', 12);

    // // 显示字符串
    // OLED_ShowString(1, 4, "Fairy tale", 12);

    // // 显示数字
    // OLED_ShowNum(0, 6, 8266, 6, 12);
